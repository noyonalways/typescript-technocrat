...
- [TS Get Started](#ts-get-started)
  - [TypeScript Compiler](#typescript-compiler)
  - [1. Installing the Compiler](#1-installing-the-compiler)
    - [local install](#local-install)
    - [Global Install](#global-install)
  - [2. Check the version of TypeScript](#2-check-the-version-of-typescript)
  - [3. Configuring the compiler](#3-configuring-the-compiler)
    - [Run TypeScript code](#run-typescript-code)
...
Version 5.3.3 or showing the latest version
